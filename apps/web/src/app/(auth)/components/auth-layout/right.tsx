...
export default function AuthRight({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <div className='flex items-start justify-center flex-col h-full w-full md:w-1/2 lg:w-2/5 bg-orange-500 relative overflow-hidden'>
      ...
      <div className='flex justify-center xs:items-center h-full w-full relative z-20'>{children}</div>
    </div>
  );
}
